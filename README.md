# � MS-RCPSP Analysis - Multi-Skill## ⚙️ Installation
...
```trained Project Scheduling

Ce projet implémente une suite complète d'algorithmes heuristiques pour l'ordonnancement de projets avec contraintes de ressources (MS-RCPSP). Il analyse et compare différentes règles de priorité pour optimiser le makespan (durée totale du projet).
